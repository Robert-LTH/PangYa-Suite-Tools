...
namespace PangyaAPI.SQL.Manager
{
    public class postgresql : database
    {
        ...
        public override void connect()
        {
            ...
            {
                PangyaLog.Write("[mssql::Connect][Error] " + ex.Message + "]", LogDestination.GeneralFile | LogDestination.Console);
                m_connected = false;
            }
        }
        ...
        public override response ExecQueryWithParams(string _proc_name, string[] parameter = null, SqlDbType[] tipo = null, object[] valor = null, ParameterDirection Direcao = ParameterDirection.Input)
        {
            ...
            catch (exception ex)
            {
                ...
                PangyaLog.Write("[mssql::ExecProcWithParams][Error] " + ex.getFullMessageError() + "]", LogDestination.GeneralFile | LogDestination.Console);
                return res;
