    ...
    public abstract class database
    {
        ...
        public void init()
        {
            ...
            if (m_ctx_db == null || string.IsNullOrEmpty(m_ctx_db.engine))
                throw new ArgumentNullException(nameof(m_ctx_db), SqlMessages.Get("ContextRequired"));
            ...
            switch (m_ctx_db.engine.ToUpper())
            {
                ...
                case "PGSQL":
                    ...
                    break;
                default:
                    throw new NotSupportedException(SqlMessages.Format("EngineUnsupported", m_ctx_db.engine));
            }
            m_state = true;
        }
