   ...
   : this(timeMs, null, tipo, onTimeFinish, autoRepeat) { }
        ...
        private void TickTime()
        {
            ...
            try
            {
                ...
                //_smp.legacy logging queue.getInstance().push(
                //    new legacy_log_entry($"[PangyaSyncTimer::TickTime][Log] Time: {timeLog}", legacy_log_destination.CL_ONLY_CONSOLE_DEBUG));
            ...
            {
                PangyaLog.Write(                                        $"[PangyaSyncTimer][Error] -> " + ex.getFullMessageError(), LogDestination.Debugger);
            }
        }
