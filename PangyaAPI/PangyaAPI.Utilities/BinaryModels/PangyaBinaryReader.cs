...
namespace PangyaAPI.Utilities.BinaryModels
{
    public class PangyaBinaryReader : BinaryReader
    {
        ...
        public PangyaBinaryReader(Stream input) : this(input, PangyaEncoding.Current)
        {
        }

        public PangyaBinaryReader(Stream input, Encoding encoding) : this(input, encoding, false)
        {
        }
        ...
        public string ReadSJISString()
        {
            ...
            {
                Console.WriteLine(UtilityMessages.Format("ShiftJisReadFailed", ex.Message));
                return string.Empty;
            }
        }
        ...
        public Object ReadObject(object obj)
        {
            foreach (var property in obj.GetType().GetProperties())
            {
                ...
                switch (typeCode)
                {
                    ...
                    default:
                        {
                            Console.WriteLine(UtilityMessages.Format("ObjectTypeName", typeCode));
                        }
                        break;
                }
            }
