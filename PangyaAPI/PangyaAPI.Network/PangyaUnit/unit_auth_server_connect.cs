...
namespace PangyaAPI.Network.PangyaUnit
{
    ...
    {
        public unit_auth_server_connect(Server server, EndpointOptions authServer) : base(server.m_si, authServer)
        {
            this.m_owner_server = server;

            if (m_state == STATE.FAILURE)
            {
                PangyaLog.Write("[unit_auth_server_connect::unit_auth_server_connect][Error] na inicializacao unit auth server connect", LogDestination.GeneralFile | LogDestination.Console);
                return;
            }
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::unit_auth_server_connect][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestFirstPacketKey(UnitPlayer _session, packet _packet)
        {
            ...
            try
            {
                ...
                CmdNewAuthServerKey cmd_nask = new CmdNewAuthServerKey(_session.m_si.Id); // Waiter
                ...
                p.WriteUInt32((uint)_session.m_si.Id);
                p.WriteString(_session.m_si.Name);
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestFirstPacketKey][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestAskLogin(UnitPlayer _session, packet _packet)
        {
            ...
            try
            {
                ...
                {
                    PangyaLog.Write("[unit_auth_server_connect::requestAskLogin][Log] Nao conseguiu logar com o Auth Server.", LogDestination.GeneralFile | LogDestination.Console);
                }
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestAskLogin][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestShutdownServer(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestShutdownServer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestBroadcastNotice(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestBroadcastNotice][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestBroadcastTicker(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestBroadcastTicker][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestBroadcastCubeWinRare(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestBroadcastCubeWinRare][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestDisconnectPlayer(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestDisconnectPlayer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestConfirmDisconnectPlayer(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestConfirmDisconnectPlayer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestNewMailArrivedMailBox(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestNewMailArrivedMailBox][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestNewRate(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestNewRate][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestReloadSystem(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestReloadSystem][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestInfoPlayerOnline(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestInfoPlayerOnline][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestConfirmSendInfoPlayerOnline(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestConfirmSendInfoPlayerOnline][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestSendCommandToOtherServer(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestSendCommandToOtherServer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void requestSendReplyToOtherServer(UnitPlayer _session, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::requestSendReplyToOtherServer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void sendConfirmDisconnectPlayer(uint _server_uid, uint _player_uid)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::sendConfirmDisconnectPlayer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void sendDisconnectPlayer(uint _server_uid, uint _player_uid)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::sendDisconnectPlayer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void sendInfoPlayerOnline(uint _server_uid, AuthServerPlayerInfo _aspi)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::sendInfoPlayerOnline][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void getInfoPlayerOnline(uint _server_uid, uint _player_uid)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::getInfoPlayerOnline][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void sendCommandToOtherServer(uint _server_uid, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::sendCommandToOtherServer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        public virtual void sendReplyToOtherServer(uint _server_uid, packet _packet)
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::sendReplyToOtherServer][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }

        protected override void onHeartBeat()
        {
            // Connection health and reconnection are owned by unit_connect_base.
        }
        ...
        protected override void onConnected()
        {
            ...
            catch (exception e)
            {
                ...
                PangyaLog.Write("[unit_auth_server_connect::onConnected][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        protected override void onDisconnect()
        {
            ...
            try
            {
                ...
                // Log
                PangyaLog.Write("[unit_auth_server_connect::onDisconnect][Log] Desconectou do Auth Server.", LogDestination.GeneralFile | LogDestination.Console);

            }
            catch (exception e)
            {

                PangyaLog.Write("[unit_auth_server_connect::onDisconnect][ErrorSystem] " + e.getFullMessageError(), LogDestination.GeneralFile | LogDestination.Console);
            }
        }
        ...
        void AddPacketHandler(byte packetId, Action<unit_auth_server_connect, Session, packet> handler)
        {
            funcs.addPacketCall(packetId, (object _arg1, ParamDispatch _arg2) =>
            {
                ...
                catch (exception e)
                {
                    ...
                    PangyaLog.Write($"[packet_func::packet{hexId}][ErrorSystem] {e.getFullMessageError()}", LogDestination.GeneralFile | LogDestination.Console);
                }
