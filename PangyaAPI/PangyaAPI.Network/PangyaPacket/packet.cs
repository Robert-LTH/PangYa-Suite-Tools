...
namespace PangyaAPI.Network.PangyaPacket
{
    ...
    public partial class packet : IDisposable
    {
        ...
        private void SetBuffer(byte[] data)
        {
            ...
            _writer = new PangyaBinaryWriter(_stream, PangyaEncoding.Current, leaveOpen: true);
            _reader = new PangyaBinaryReader(_stream, PangyaEncoding.Current, leaveOpen: true);
        }
        public uint GetSize
        {
            get => _reader.Size;
