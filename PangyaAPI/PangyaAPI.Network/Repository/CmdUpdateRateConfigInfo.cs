...
namespace PangyaAPI.Network.Repository
{
    public class CmdUpdateRateConfigInfo : Pangya_DB
    {
        ...
        protected override Response prepareConsulta()
        {
            ...
            var r = procedure(
                "pangya.ProcUpdateRateConfigInfo",
                m_server_uid,
                m_rci.grand_zodiac_event_time,
                m_rci.scratchy,
                m_rci.papel_shop_rare_item,
                m_rci.papel_shop_cookie_item,
                m_rci.treasure,
                m_rci.pang,
                m_rci.exp,
                m_rci.club_mastery,
                ...
                m_rci.memorial_shop,
                m_rci.angel_event,
                m_rci.grand_prix_event,
                m_rci.golden_time_event,
                m_rci.login_reward_event,
                m_rci.bot_gm_event,
                m_rci.smart_calculator);
